function network = mnist_auto_softplus_losslog()
clc
...
opt.n_hidden = [100, 50, 15, 2]; %[150, 100, 8]
opt.n_kernels = 15;
opt.gmm_sigma = 'full';
...
opt.weights_load_file = 'Data/mnist_softplus_losslog(_100_50_25_5_)04-Apr-2017 17:37:24.mat';
opt.weights_save_file = 'mnist_softplus_losslog';
...
loss_r{1} = -1.0.*(reduce_mean(x.*log(r{1}) + (1.0-x).*log(1.0 - r{1}), [1, 2])) + 0.00001.*reg;
