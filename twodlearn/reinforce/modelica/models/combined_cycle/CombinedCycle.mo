...
package Tdl
   model CC0D_explicit_x0
      import Plants = CombinedCycle.Optimization.Plants;
      import Types = CombinedCycle.Types;
      extends Plants.CC0D;
      parameter Types.Temperature superheater_gas_side__gas_out__T_init = 625; // 746
      parameter Types.Temperature evaporator_gas_side__gas_out__T_init = 500;  // 454
      parameter Types.Temperature economizer_gas_side__gas_out__T_init = 450;  // 490
      parameter Types.Temperature economizer__wat_liq_out__T_init = 400;       // 459
      parameter Real evaporator__alpha_init = 0.5;
      parameter Types.Pressure evaporator__p_init = 3000000.0;                 // 7.5e6
      parameter Types.Temperature superheater__wat_vap_out__T_init = 550.0;    // 797
      parameter Types.Temperature turbineShaft__T__2_init = 550.0;             // 791
      parameter Real PI__x_init = 0.0;
      initial equation
         // economizer.wat_liq_out.T = 459;
         // economizer_gas_side.gas_out.T= 490;
         // evaporator.p= 7.5e6;
         ...
         // superheater_gas_side.gas_out.T = 746;
         // turbineShaft.T__2 = 791;
         superheater_gas_side.gas_out.T = superheater_gas_side__gas_out__T_init;
         evaporator_gas_side.gas_out.T = evaporator_gas_side__gas_out__T_init;
         economizer_gas_side.gas_out.T = economizer_gas_side__gas_out__T_init;
         economizer.wat_liq_out.T = economizer__wat_liq_out__T_init;
         evaporator.alpha = evaporator__alpha_init;
         evaporator.p = evaporator__p_init;
         superheater.wat_vap_out.T = superheater__wat_vap_out__T_init;
         turbineShaft.T__2 = turbineShaft__T__2_init;
         PI.x = PI__x_init;
